...
const public_dist_folder = '../oden_backend/src/main/resources/public/';
const test_dist_folder = 'dist';
...
export default {
  ...
  output: {
    path: path.resolve(__dirname, public_dist_folder),
    //path: path.resolve(__dirname, 'dist'),
    // publicPath: public_dist_folder,
